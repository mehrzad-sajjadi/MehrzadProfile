<template>
  <section class="text-white mt-20" id="connetc">
    ...
    >
      <div>
        <p class="text-[#adb7be] text-justify">
        ...
        <div class="col-lg-4 col-md-4 mb-lg-0 mt-5">
          <div class="flex mb-10 items-center">
            <div
              ...
              "
            >
              <img src="@/assets/img/telegram.png" alt="telegram" class="w-6" />
            </div>
          ...
          <div class="flex mb-10 items-center">
            <div
              ...
              "
            >
              <img src="@/assets/img/phone.png" alt="phone" class="w-6" />
            </div>
            <div class="ml-5 text-white">
              <h4>Phone</h4>
              <p>+989376862880</p>
          ...
          <div class="flex mb-10 items-center">
            <div
              ...
              "
            >
              <img src="@/assets/img/linkedin.png" alt="linkedin" class="w-6" />
            </div>
            <div class="ml-5 text-white">
              <h4>LinkedIn</h4>
              <p>www.linkedin.com/in/seyed-mehrzad-sajjadi/</p>
            </div>
          </div>
        </div>
      </div>
